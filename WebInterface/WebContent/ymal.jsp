...
<%
	...
	try {
		...
		sql = "select distinct g.title " +
				...
				"where b.gamerid " + option + " and b.title = a.title and b.rating >= 3) c, plays d " +
				"where d.gamerid = c.gamerid and d.title <> c.title and d.rating >= 3)" + " q, Games g, Players p " +
		...
		sql = "select distinct s.title, o.deviceid, o.os as own, s.os as supports " +
				"from owns o, supports s, " + "(select d.title " +
						"from " +
						"(select b.gamerid, b.title " +
						"from " +
						"(select title " +
						...
						"where gamerid = " + session.getAttribute("gamerID") + " and rating >= 3) a, plays b " +
						"where b.gamerid " + option + " and b.title = a.title and b.rating >= 3) c, plays d " +
						"where d.gamerid = c.gamerid and d.title <> c.title and d.rating >= 3) g " + 
		...
		sql = "select distinct s.* " + 
				"from supports s, (select d.title " +
				"from " +
				"(select b.gamerid, b.title " +
				"from " +
				"(select title " +
